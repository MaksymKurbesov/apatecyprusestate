    ...
    <div className={styles["terms-of-use"]}>
      <div className={"container"}>
        <div className={styles["header"]}>
          <h1>{t("documents.terms")}</h1>
          <p>{t("documents.subtitle_current")}</p>
          <NavLink
            to={"/our-contacts"}
            className={`${styles["contacts"]} button`}
          >
            {t("documents.contacts")}
          </NavLink>
        </div>
        <div>
          <strong>AGREEMENT TO OUR LEGAL TERMS</strong>
          <p>
            We are Apate Cyprus Estate ("Company," "we," "us," "our"), a company
            registered in Cyprus at Basilissis Phreiderikis, 20, EL GRECO HOUSE,
            Floor 1, Flat/Office 104, Nicosia 1066.
          </p>

          <p>
            We operate the website http://www.apatecyprusestate.com (the{" "}
          ...
          <p>
            Specialists in real estate investment in Cyprus. High quality
            service, personalized approach and the best properties for your
            investment. Contact us today!
          </p>

          <p>
            You can contact us by phone at +35722761795, email at
            support@apatecyprusestate.com, or by mail to Basilissis
            Phreiderikis, 20, EL GRECO HOUSE, Floor 1, Flat/Office 104, Nicosia
            1066, Cyprus.
          </p>
          ...
          <p>
            ...
            <strong>"you"</strong>), and Apate Cyprus Estate, concerning your
          ...
          <p>
            ...
            support@apatecyprusestate.com, as stated in the email message. By
        ...
        <div>
          ...
          <p>
            ...
            please address your request to: support@apatecyprusestate.com. If we
        ...
        <div>
          ...
          <br />
          We accept the following forms of payment: - Cryptocurrency - Perfect
          Money
          <br />
          <br />
          <p>
        ...
        <div>
          ...
          <p>
            ...
            Services are hosted in Cyprus. If you access the Services from any
            ...
            applicable laws in Cyprus, then through your continued use of the
            Services, you are transferring your data to Cyprus, and you
        ...
        <div>
          ...
          <p>
            ...
            of Cyprus, and the use of the United Nations Convention of Contracts
            ...
            provisions of the law in your country to residence. Apate Cyprus
            Estate and yourself both agree to submit to the non-exclusive
            jurisdiction of the courts of Nicosia, which means that you may make
            a claim to defend your consumer protection rights in regards to
            these Legal Terms in Cyprus, or in the EU country in which you
            reside.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            arbitration shall be Nicosia, Cyprus. The language of the
            proceedings shall be English. Applicable rules of substantive law
            shall be the law of Cyprus.
          </p>
