    ...
    <div className={styles["privacy-policy"]}>
      <div className={"container"}>
        <div className={styles["header"]}>
          ...
          <p>{t("documents.subtitle_current2")}</p>
          <NavLink
            to={"/our-contacts"}
        ...
        <div>
          <div>
            This privacy notice for Apate Cyprus Estate
            <strong>("we," "us," or "our")</strong>, describes how and why we
            might collect, store, use, and/or share <strong>("process")</strong>
            ...
            contact us at <strong>support@apatecyprusestate</strong>.
          </div>
          <div>
            ...
            <br /> <br /> Want to learn more about what we do with any
          ...
          <div>
            ...
            <br /> <br /> We collect personal information that you voluntarily
            ...
            <br /> <br /> We automatically collect certain information when you
            ...
            <br /> <br /> Like many businesses, we also collect information
          ...
          <div>
            ...
            platform.
            <br /> <br /> We will use the information we receive only for the
          ...
          <div>
            ...
            <br /> <br /> When we have no ongoing legitimate business need to
          ...
          <div>
            ...
            <strong>support@apatecyprusestate.com.</strong>
          </div>
          <div>
            ...
            below.
            <br /> <br /> However, please note that this will not affect the
          ...
          <div>
            ...
            us at <strong>support@apatecyprusestate.com</strong> or contact us
            by post at:
            <strong>
              Basilissis Phreiderikis, 20, EL GRECO HOUSE, Floor 1, Flat/Office
              104 1066, Leukosia, Cyprus
            </strong>
          </div>
          <h2>
